...
var sassLoader = {
  ...
  process({
    ...
    return new Promise((resolve, reject) => {
      ...
      return workQueue.add(() => render(_objectSpread2(_objectSpread2({}, this.options), {}, {
        file: this.id,
        data: data + code,
...
var lessLoader = {
  ...
  process({
    ...
    return _asyncToGenerator(function* () {
      ...
      let _yield$pify = yield pify(less.render.bind(less))(code, _objectSpread2(_objectSpread2({}, _this.options), {}, {
        sourceMap: _this.sourceMap && {},
        filename: _this.id
      })),
          css = _yield$pify.css,
    ...
    generateBundle(options_, bundle) {
      ...
      return _asyncToGenerator(function* () {
        ...
        const getExtracted = () => {
          ...
          if (modules) {
            const moduleIds = [..._this2.getModuleIds()];
